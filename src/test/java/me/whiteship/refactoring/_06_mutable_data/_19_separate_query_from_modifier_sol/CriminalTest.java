package me.whiteship.refactoring._06_mutable_data._19_separate_query_from_modifier_sol;
...
class CriminalTest {
    ...
    void alertForMiscreant() {
        ...
        found = criminal.findMiscreant(List.of(new Person("Sohyun"), new Person("Elmo")));
        assertEquals("", found);
    }
